...
const Sponsors = () => {
  return (
    <section id='sponsors' className='flex justify-center items-center flex-col w-screen min-h-[100vh] relative overflow-visible '>
        ...
        <a href=""className='text-Ccream border-2 border-Ccream px-5 py-2 rounded-xl mt-2 mb-5' >Sponsor Us</a>
        <div className='w-screen overflow-hidden bg-Cblue min-h-[40vh]'>
...
const Box = ({image, name}) => {
  return (
    <div className=' w-auto space-y-8 flex justify-center items-center flex-col h-[40vh]' >
                    <div className='h-[22vh] aspect-square bg-Corange rounded-xl rotate-12 grid place-content-center' >
                        <Image src={`/images/${image}.png`} className='w-[80%] mx-auto -rotate-12' width={400} height={400} alt="" />
                    </div>
