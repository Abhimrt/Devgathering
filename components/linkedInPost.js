...
const Box = ({
  ...
  return (
    <div className="w-[90%] mx-auto lg:w-[28%]  flex items-center justify-end min-h-[20vh]  flex-col relative ">
      <div className="w-full h-[350px] rounded-2xl bg-gray-200 hoverEffect flex shadow-lg shadow-black items-center justify-end flex-col  pb-5 text-Cblue relative  mt-[100px] lg:mt-0">
        <Image
          src={`/images/${image}`}
          className=" rounded-full p-4 hoverEffectChild  border-gray-500 border-4 absolute w-[170px] top-[-100px]"
