        ...
        <div className='relative mb-28 w-screen'>
            ...
            <section className='flex justify-center items-center flex-col my-10 mt-28 lg:mt-40'>
                <h1 className='cursor-pointer  text-3xl lg:text-4xl font-semibold tracking-widest'>{"{"}Problem
                    ...
                    <button onFocus={handleFocus} onBlur={handleBlur} className='h-full w-full flex justify-end mt-2 lg:mt-0 lg:justify-start lg:w-min lg:block' data-popover-target="popover-description" data-popover-placement="bottom-end" type="button">
